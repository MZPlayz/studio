  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black font-sans">
      <header className="sticky top-0 z-10 flex items-center border-b bg-white dark:bg-gray-900 dark:border-gray-800 p-4">
        ...
        <h1 className="flex-1 text-center text-xl font-bold text-gray-800 dark:text-gray-100">রুলস ও নির্দেশনা</h1>
        <div className="w-10" />
      </header>
      ...
      <main className="p-4">
        <Card className="bg-white dark:bg-gray-900 dark:border-gray-800">
          <CardHeader>
            <CardTitle className="text-gray-800 dark:text-gray-100">Rules & Instructions</CardTitle>
          </CardHeader>
          <CardContent className="prose prose-sm max-w-none text-gray-700 dark:text-gray-300">
            <p>
            ...
            <h3 className="font-bold mt-4 text-gray-800 dark:text-gray-100">User Conduct</h3>
            <p>
            ...
            <h3 className="font-bold mt-4 text-gray-800 dark:text-gray-100">Payments and Fares</h3>
            <p>
